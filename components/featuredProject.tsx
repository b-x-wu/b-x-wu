...
export default function FeaturedProject ({ name, description, imagePath, url }: FeaturedProjectProps): JSX.Element {
  return (
    <Link
      ...
      className='group relative h-48 ring-4 ring-lighter-blue transition-all duration-300 dark:ring-darkest-blue'
    >
      ...
      <div className='absolute inset-0 h-full w-full bg-lighter-blue opacity-90 transition-all duration-300 group-hover:opacity-0 dark:bg-darkest-blue dark:opacity-95'>
