...
export function Console (props: ConsoleProps): JSX.Element {
  ...
  if (props.consoleMessage.type === ConsoleMessageType.ERROR) {
    return (
      <div className='fixed top-20 right-0 z-10 flex w-screen flex-row items-center gap-x-3 bg-[#F33]/70 py-4 px-8 text-[#FFF]'>
  ...
  return (
    <div className='absolute top-0 right-0 z-10 flex w-screen flex-row items-center gap-x-3 bg-[#FC0]/70 p-4 text-[#FFF]'>
