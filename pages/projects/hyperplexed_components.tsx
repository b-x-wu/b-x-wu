        ...
        <div className="mx-auto flex flex-col items-center gap-y-8 pb-10">
            <div className='flex w-[60%] flex-col gap-y-10 pt-10 pb-0'>
                ...
                <div className='flex flex-col gap-y-4'>
                  ...
                  <p className='leading-loose'>
                      Find the code for these components in <Link href="https://github.com/bruce-x-wu/hyperplexed-components" target='_blank' rel="noreferrer" className='font-bold hover:underline'>this GitHub repo</Link>.
                  </p>
                </div>
                <ComponentDisplay
                    width={600}
...
`<div className='flex h-full flex-col justify-center bg-[#101020] font-shareTechMono text-2xl'>
  ...
  />
                ...
                >
                    <div className='flex h-full flex-col justify-center bg-[#101020] font-shareTechMono text-2xl font-bold text-glacier'>
                        <FancyGradientHoverLinks
                            linkInfos={[
                              {
                                text: 'Video',
...
`<div className='flex h-full flex-col justify-center bg-[#101010] p-10 text-center text-2xl font-medium'>
  <div>
    Maybe the real React components were the <MagicalText>friends</MagicalText> we made along the way.
                    ...
                    titleStyle={{ fontSize: '1.5rem', lineHeight: '2rem', fontWeight: 'bold', maxWidth: '100%' }}
                >
                    <div className='flex h-full flex-col justify-center bg-[#101010] p-10 text-center text-2xl font-medium text-glacier'>
                        <div>
                            Maybe the real React components were the <MagicalText>friends</MagicalText> we made along the way.
                        </div>
                    </div>
...
`<div className='flex h-full flex-col justify-center bg-[#101010] text-4xl'>
  ...
  />
                    ...
                    titleStyle={{ fontSize: '1.5rem', lineHeight: '2rem', fontWeight: 'bold', maxWidth: '100%' }}
                >
                    <div className='flex h-full flex-col justify-center bg-[#101010] text-4xl text-glacier'>
                        <SuperHeaderSlider
                            leftChildren={
                                <h2 className='w-full pl-2'>
                                    Good luck,&nbsp;
